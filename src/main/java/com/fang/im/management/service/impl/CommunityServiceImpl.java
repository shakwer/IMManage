...
public class CommunityServiceImpl {
  ...
  public Integer addCommunityFromImUrlNew(String grouptitle,String grouplist,String grouplord,String limit,String groupnotice,String categoryid,String projectid,String issystemcreate)
          throws Exception {
    String addCommunityImUrl = PropertiesUtils.getBatchInviteCreateInstructionUrl(grouptitle, grouplist, grouplord, limit, groupnotice, categoryid, projectid, issystemcreate);
    String result = HttpClientUtils.requestUrl(addCommunityImUrl, 1000 * 3, "utf-8");
    JSONObject jsonObject = JSON.parseObject(result);
    String retCode = jsonObject.getString("ret_code");
    String data = jsonObject.getString("data");
    int communityId;
    if ("1".equals(retCode) && !StringUtils.isEmpty(data)) {
      communityId = Integer.parseInt(data);
    } else {
      communityId = 0;
    }
    return communityId;
