...
<body>
	...
	<div class="content">
		<div class="content-c">
			<div class="section">
				<div style="color: #df3031;font-weight: 600;font-size: 14px;"><a href=#” onClick="javascript :history.back(-1);" style="color:#df3031"><img src="/resources/images/right_arr.png"/> 成员列表</a></div>
				...
				<div class="section-c">
					...
					<table id="memberTable" class="tables1">
						<tr>
							...
							<th>IM账号</th>
							<th>性别</th>
							<th>入群时间<img src="/resources/images/xx.jpg"></th>
							<th>最后发言<img src="/resources/images/xx.jpg"></th>
							<th>状态</th>
							<th>操作</th>
						</tr>
					</table>
							...
							<div class="tab-line clearfix">
								...
								<div class="tl-left de">
									<div class="t">
										已选成员
										<div class="p-num">
											<i id="recentMemberCount">0</i> <span>/</span> <i id="recentMemberLimit">0</i>
										</div>
									</div>
									<div class="c">
										<div class="c-list cur">
	...
	<script src="/resources/js/cyguanli.js"></script>
	...
	<script type="text/javascript">
		...
		function getPageList() {
			$.post("/searchMember.do", searchO, function(data) {
				refresh(data);
		...
		function refresh(res) {
			...
			memberTable.empty();
			var head = $("<tr><th></th><th></th><th></th><th class=\"special\">成员(昵称)</th><th>群名片</th><th>IM账号</th><th>入群时间<img onclick=\"addtimechange();\" src=\"/resources/images/xx.jpg\"></th><th>最后发言<img onclick=\"messagetimechange();\" src=\"/resources/images/xx.jpg\"></th><th>状态</th><th>操作</th></tr>");
			...
			for (; i < length; i++) {
				...
				case "owner":
					src = "/resources/images/qunzhu.png";
					break;
				case "common":
					src = "";
					break;
				...
				var img2 = $("<img/>");
				img2.attr("class", "tx");
				img2.attr("src", "/resources/images/q.jpg");
				img2.css("width", "20px");
				...
				if (data[i].forbidden == "0") {
					state = "正常";
					img4.attr("src", "/resources/images/jinyan.png");
					img4.attr("title", "禁言");
					img4.click(function() {
					...
					state = "禁言";
					img4.attr("src", "/resources/images/jinyan_h.png");
				...
				img3.attr("src", "/resources/images/bianji.png");
				img3.attr("title", "编辑");
				...
				img5.attr("src", "/resources/images/delete.png");
				img5.attr("title", "删除");
				...
				if (data[i].black == "1") {
					state = "拉黑";
					tds[8].text(state);
					img6.attr("src", "/resources/images/black.png");
					img6.attr("title", "解除拉黑");
					img6.click(function() {
						var res = confirm("解除对成员(" + $(this).attr("memberid")
								+ ")的拉黑?");
						if (res) {
							$.post("/unblackMember.do", {
								"groupid" : $("#groupinfo_id").attr("groudid"),
								"username" : $(this).attr("memberid")
							}, function(data) {
								if (data == "success") {
					...
					state = "正常";
					img6.attr("src", "/resources/images/noblack.png");
					img6.attr("title", "拉黑");
					img6.click(function() {
			...
			$.post("/getMemberById.do", {
				...
				if (data.forbidden == "0") {
					...
					var img = $($($("#" + row).children("td")[9]).children(
							"img")[1]);
					img.attr("title", "禁言");
					img.attr("src", "/resources/images/jinyan.png");
					img.unbind();
					img.click(function() {
					...
					var img = $($($("#" + row).children("td")[9]).children(
							"img")[1]);
					img.attr("title", "解除禁言");
					img.attr("src", "/resources/images/jinyan_h.png");
					img.unbind();
					img.click(function() {
		...
		function fillCommunity(data) {
			...
			for (; i < length; i++) {
				...
				var img = $("<img/>");
				img.attr("src", "/resources/images/q.jpg");
				if (data[i].pic != "") {
