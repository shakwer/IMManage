/**
 * File：SysUserOperateService.java
 * Package：com.fang.im.management.service
 * Author：jin
 * Date：2017年4月11日 下午2:05:25
...
/**
 * <p>
 * Description: SysUserOperateService
 * </p>
 *
 * @author jinshilei
 *         2017年4月11日
 ...
 *
 */
public interface SysUserOperateService {
   ...
   *         异常
   */
  boolean addNewUser(String email, String imUserName, String realName, Set<SysCity> cities,
