...
<body>
            ...
            <div class="section-c">
              <div class="outline clearfix">
                ...
                <div class="outline-right">
                  <input class="input-sty1" type="text" name="" id="selectdelgroup" placeholder="搜索关键词"> <span
                    class="btn" style="margin-right: 0; padding: 0 20px;" id="delfind">搜索</span>
                </div>
              </div>
              <!-- 删除列表 -->
              <table class="tables1">
                <thead>
                  <tr>
                    ...
                    <th>群所在城市</th>
                    <th>群人数/人数上限</th>
                    <th>创建时间<img id="delorder" src="<%=contextPath%>/resources/images/xx.jpg"></th>
                    <th>最后发言时间</th>
                    <th>操作</th>
                  </tr>
                </thead>
                <tbody id="tbody2">
                  <c:choose>
                    <c:when test="${not empty communitylists && communitylists.size() >0}">
                      <c:forEach items="${communitylists}" var="communityitem" varStatus="status">
                        <tr>
                          ...
                          <td class="special"><img class="tx" src="<%=contextPath%>/resources/images/q.jpg"><input
                            class="changed-input" type="text" value="${communityitem.getCommunityname()}"
                            disabled="disabled">(${communityitem.getCommunityid()})</td>
                          <td><input class="changed-input" type="text" value="${communityitem.getCategoryname()}"
                          ...
                          <td style="width: 100px;"><img class="ibtn huifuQun"
                            src="<%=contextPath%>/resources/images/huifu1.png" title="恢复"></td>
                        </tr>
                      </c:forEach>
                    </c:when>
                    <c:otherwise>
                        ...
                        <c:choose>
                          <c:when test="${totalpage<=3 }">
                            <c:forEach begin="1" end="${totalpage }" var="stat">
                              <div id="delfront_${stat }" <c:if test="${stat==pageindex}">class="cur"</c:if>>${stat }</div>
                            </c:forEach>
                          </c:when>
                          <c:otherwise>
                            <c:forEach begin="${totalpage-pageindex>2?pageindex:(totalpage-2) }"
                              end="${pageindex+(totalpage-pageindex>2?2:(totalpage-pageindex)) }" var="stat">
                              <div id="delfront_${stat }" <c:if test="${stat==pageindex}">class="cur"</c:if>>${stat }</div>
                            </c:forEach>
              ...
              <table class="tables1">
                <thead>
                  <tr>
                    ...
                    <th>群所在城市</th>
                    <th>群人数/人数上限</th>
                    <th>创建时间<img id="order" src="<%=contextPath%>/resources/images/xx.jpg"></th>
                    <th>最后发言时间</th>
                    <th>操作</th>
                  </tr>
                </thead>
  ...
  <c:otherwise>
    src="<%=contextPath%>/resources/images/q.jpg"
                            ...
                            height="20" width="20"><input class="changed-input groupname-input" type="text"
                            value="${communityitem.getCommunityname()}" disabled="disabled">(${communityitem.getCommunityid()})</td>
                          <td>
                          ...
                          <td>
                            ...
                            <a href="javascript:changeGroup('${communityitem.getCommunityid()}',encodeURI('${communityitem.getCommunityname()}'),${communityitem.getImurlout().getCount() == null ? "-" : communityitem.getImurlout().getCount()},${communityitem.getImurlout().getLimit() == null ? "-" : communityitem.getImurlout().getLimit()})" class="ibtn changeGroup" src="<%=contextPath%>/resources/images/fenxiang.png" title="成员" id="changeGroup">成员</a>
                          </td>
                        </tr>
                      </c:forEach>
                    </c:when>
                    ...
                    <c:choose>
                      <c:when test="${totalpage>0 }">
                        <c:choose>
                          <c:when test="${totalpage<=3 }">
                            <c:forEach begin="1" end="${totalpage }" var="stat">
                              <div id="front_${stat }" <c:if test="${stat==pageindex}">class="cur"</c:if>>${stat }</div>
                            </c:forEach>
                          </c:when>
                          <c:otherwise>
                            <c:forEach begin="${totalpage-pageindex>2?pageindex:(totalpage-2) }"
        ...
        <div class="alert-tab">
          <div class="tab-c">
            <div class="tab-c-item">
              <div class="tab-line clearfix">
                ...
                <select>
                  ...
                  <option value="">特价房</option>
                  <option value="">特价租房</option>
                  <option value="">经纪人</option>
                  <option value="">装修</option>
                  <option value="">业内</option>
                  <option value="">楼盘群</option>
                </select>
              </div>
              <div class="tab-line clearfix">
            ...
            <div class="tab-c-item" style="display: none;">
              <div class="tab-line clearfix">
                <input class="input-sty2" type="text" id="addinput" placeholder="用户名">
          ...
          <div class="erweima-o clearfix addcomqr">
            ...
            <div>
              <div class="ewm-text" style="margin-bottom: 10px;">
                <a class="jiathis_button_loadlink" data-clipboard-text="" id="copylink">复制</a>
              </div>
              <div class="ewm-text">
          ...
          <div class="tab-c">
            <div class="tab-c-item">
              <div class="tab-line clearfix" style="padding-top: 0">
                <input class="input-sty2" type="text" id="singleaddinput" placeholder="用户名">
            ...
            <div class="tab-c-item">
              <div class="tab-line clearfix" style="padding-top: 0">
                ...
                <div style="float: right;">
                  <input class="input-sty2" type="text" id="transferinput" placeholder="邮箱">
  ...
  <div class="alert-box sty2 delBox">
    <div class="alert">
      ...
      <div class="alert-con">
        <p style="padding: 50px 0; text-align: center; color: #333; font-size: 16px;">确认要删除该群吗？</p>
      </div>
      <!-- alert-con end -->
      <div class="btn1-o">
  ...
  <div class="alert-box sty2 huifuBox">
    <div class="alert">
      ...
      <div class="alert-con">
        <p style="padding: 45px 0; text-align: center; color: #333; font-size: 16px;">确认要恢复该群吗？</p>
      </div>
      <!-- alert-con end -->
      <div class="btn1-o">
  ...
  <div class="alert-box sty2 zrConfirmBox">
    <div class="alert">
      ...
      <div class="alert-con">
        <p style="padding: 50px 0; text-align: center; color: #333; font-size: 16px;">
          您确认要转让该群吗？<br> <span style="display: block; margin-top: 7px; color: #666; font-size: 12px;">点击“确定”之后，您将立即失去群主身份！</span>
        </p>
      </div>
      <!-- alert-con end -->
      <div class="btn1-o">
  ...
  <c:choose>
    <c:when test="${not empty communitylists}">
      <c:forEach items="${communitylists}" var="communityitem" varStatus="status">
        <div class="alert-box sty3 shareBox" id="divshare_${communityitem.getCommunityid()}">
          <div class="alert">
            <div class="top">
              <span class="top-h">分享"${communityitem.getCommunityname()}"到</span> <span class="close"></span>
            </div>
            <div class="alert-con clearfix" style="padding-bottom: 30px;">
              <div class="alert-share-l">
                <img src="${communityitem.getQrcode()}">
                <p style="margin-top: 5px; color: #333; font-size: 14px; text-align: center;">使用房天下app扫描分享</p>
              </div>
              <div class="alert-share-r">
                <div class="share-item">
                  <a class="jiathis_button_qzone"
                    ...
                    target="_blank" id="sharebyqq"> <img src="<%=contextPath%>/resources/images/fqq.jpg">
                  </a>
                </div>
                <div class="share-item">
                  <a class="jiathis_button_sina"
                    ...
                    target="_blank" id="sharebysina"> <img src="<%=contextPath%>/resources/images/fwb.jpg">
                  </a>
                </div>
                <div class="share-item">
                  <a class="jiathis_button_loadlink" href="#" data-clipboard-text="${communityitem.getQrurl()}"
                    id="sharebyurl"> <img src="<%=contextPath%>/resources/images/fzlianjie.jpg">
                  </a>
                </div>
                <div class="share-item">
                  <a id="aimg" href="${communityitem.getQrcode()}" download="100.jpg" id="sharebyimg"> <img
      ...
      <div class="alert-box sty3 shareBox">
        <div class="alert">
          ...
          <div class="alert-con clearfix" style="padding-bottom: 30px;">
            ...
            <div class="alert-share-r">
              <div class="share-item">
                <a class="jiathis_button_qzone" href="#" target="_blank" id="sharebyqq"> <img
                  src="<%=contextPath%>/resources/images/fqq.jpg">
                </a>
              </div>
              <div class="share-item">
                <a class="jiathis_button_sina" href="#" target="_blank" id="sharebysina"> <img
                  src="<%=contextPath%>/resources/images/fwb.jpg">
                </a>
              </div>
              <div class="share-item">
                <a class="jiathis_button_loadlink" href="#" id="sharebyurl"> <img
